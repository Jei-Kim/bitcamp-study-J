...
values(1, 'aaa', 'aaa@test.com', password('1111'), 1);

insert into member(member_no, name, email, password, phone_number)
values(2, 'bbb', 'bbb@test.com', password('1111'), 2);

insert into member(member_no, name, email, password, phone_number)
values(3, 'ccc', 'ccc@test.com', password('1111'), 3);

insert into member(member_no, name, email, password, phone_number)
values(4, 'ddd', 'ddd@test.com', password('1111'), 4);

insert into member(member_no, name, email, password, phone_number)
values(5, 'eee', 'eee@test.com', password('1111'), 5);
